...
import ethErrors from 'eth-json-rpc-errors/src/errors'
import * as sigUtil from 'eth-sig-util'

// Copied with modifications from eth-json-rpc-middleware

export function createWalletMiddleware(opts = {}) {
  ...
  async function ethSign(req, res) {
    ...
    const msgParams = { ...extraParams, from: address, data: message }
  ...
  async function personalRecover(req, res) {
    ...
    const extraParams = req.params[2] || {}
    const msgParams = { ...extraParams, sig: signature, data: message }
  ...
  async function decryptMessage(req, res) {
    ...
    const address = await validateAndNormalizeKeyholder(req.params[1], req)
    const extraParams = req.params[2] || {}
    const msgParams = { ...extraParams, from: address, data: ciphertext }
